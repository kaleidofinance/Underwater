...
import { httpLink, looksLikeImage, resolveUri } from "./uri";
 ...
 *
 * The URI rules themselves live in lib/uri.ts, because the share-card routes
 * need them on the server and this module is `"use client"`.
 */
