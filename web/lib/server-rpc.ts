 ...
 * chunk that has to be halved is halved once and each half still gets every endpoint
 * {@link serverEndpoints} offered. The other order would re-split against the next
